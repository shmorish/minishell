...
// lexer --------------------------------------------------------
// expansion_utils.c
void						expansion_free(char *before_str, char *after_str,
								char *env_str);
void						expansion_join(t_token *node, char *before,
								char *after, char *env_str);
bool						count_doller(char *data, size_t *index);
bool						expansion_check_doll_end(char *str, size_t *index);
// expansion.c
void						expansion(char *env_val, t_token *node,
								size_t start, size_t end);
char						*expansion_get_env_val(char *env_name,
								t_env *env_head, t_data *data);
void						expansion_env(char *str, t_token *node,
								size_t *index, t_data *data);
...
void						token_node_add_back(t_token *head,
								t_token *new_node);
void						token_node_add_front(t_token *head,
								t_token *new_node);
...
void						lexer_normal(char *line, size_t *index,
								t_token *token_head);
bool						lexer_token(char *line, size_t *index,
								t_token *token_head);
